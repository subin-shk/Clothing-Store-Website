...
<head>
    ...
    <title>Mens - CloverEmporium</title>
            <!-- Google Web Fonts -->
...
<section class="products" style="margin-bottom: 1000px;">
    <div class="container bg-light py-6 my-6 mt-0">
      ...
      <div class="pro_lists" >
        <h2 style="border-bottom: 1px dashed #000; padding: 10px;">Suits</h2>

             <?php
            $sql1="select * from items where product_cat='men' and item_type='suits'";
      ...
      <h2 style="border-bottom: 1px dashed #000; padding: 10px;">Tops</h2>
             <?php
            $sql1="select * from items where product_cat='men' and item_type='tops'";
            $result1=mysqli_query($conn,$sql1);
           $count = 1;
        ...
        <h2 style="border-bottom: 1px dashed #000; padding: 10px;">Bottoms</h2>
             ...
             <?php
            $sql1="select * from items where product_cat='men' and item_type='bottoms'";
            $result1=mysqli_query($conn,$sql1);
           $count = 1;
